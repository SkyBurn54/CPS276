...
$stickyForm = new StickyFormAdmin();
...
function addData($post){
  ...
  /* IF EVERYTHING WORKS ADD THE DATA HERE TO THE DATABASE HERE USING THE $_POST SUPER GLOBAL ARRAY */
      ...
      $sql = "INSERT INTO adminMod (name, email, password, stat) VALUES (:name, :email, :password, :stat)";
...
global $stickyForm;
$options = $stickyForm->createOptions($elementsArr['stat']);
