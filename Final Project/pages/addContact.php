...
$elementsArr = [
  "masterStatus"=>[
    ...
    "city"=>[
        "errorMessage"=>"<span style='color: red; margin-left: 15px;'>City cannot be blank and must be a valid city name</span>",
      "errorOutput"=>"",
      "type"=>"text",
      "value"=>"Anywhere",
          "regex"=>"city"
...
function addData($post){
  ...
  /* IF EVERYTHING WORKS ADD THE DATA HERE TO THE DATABASE HERE USING THE $_POST SUPER GLOBAL ARRAY */
      ...
      $sql = "INSERT INTO contactMod (name, address, city, state, phone, email, DOB, contactType, ageRange) VALUES (:name, :address, :city, :state, :phone, :email, :DOB :contactType, :ageRange)";
